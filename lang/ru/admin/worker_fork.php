...
$MESS["BITRIX_XSCAN_FILE_ERROR"] = "Ошибка при обработке файла";
...
$MESS["BITRIX_XSCAN_DOWNLOAD"] = "скачать";
$MESS["BITRIX_XSCAN_HIDE"] = "Файл будет удалён из результатов, чтобы его вернуть нужно будет повторить сканирование. Продолжть?";
$MESS["BITRIX_XSCAN_HIDED"] = "Файл удалён из результатов: ";
$MESS["BITRIX_XSCAN_HIDE_BTN"] = "Скрыть";
